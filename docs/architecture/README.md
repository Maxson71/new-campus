...
#### Модуль керування курсами (Course Module) ####

![](./img/CourseModule.png)

- **CreateCourse:** Компонент, який дозволяє викладачам створювати нові курси, вказуючи інформацію про них (назва, опис, розклад тощо).
- **AddStudent:** Компонент, що дозволяє викладачам додати студента до курсу.
- **CourseDetails:** Компонент, який показує детальну інформацію про курс (викладачі, студенти, розклад).
- **Prisma Component:** Використовується для збереження інформації про курси та їх учасників у базі даних.

#### Модуль оцінок (Grades Module) ####

![](./img/GradesModule.png)

- **GradeEntry:** Компонент, який дозволяє викладачам виставляти оцінки студентам.
- **GradeView:** Компонент, який дозволяє студентам переглядати свої оцінки.
- **GradeSummary:** Компонент, що дозволяє викладачам переглядати загальну статистику успішності студентів.
- **Prisma Component:** Використовується для збереження оцінок та інформації про них у базі даних.

#### Модуль методичних матеріалів (Materials Module) ####

![](./img/MaterialsModule.png)

- **UploadMaterial:** Компонент, який дозволяє викладачам завантажувати навчальні матеріали (презентації, методички тощо).
- **ViewMaterial:** Компонент, який дозволяє студентам переглядати або завантажувати методичні матеріали.
- **MaterialManagement:** Компонент для викладачів, який дозволяє керувати завантаженими матеріалами (видалення, редагування тощо).
- **Prisma Component:** Використовується для збереження та управління інформацією про методичні матеріали у базі даних.

#### Модуль сесій (Exams Module) ####

![](./img/ExamsModule.png)

- **ScheduleExam:** Компонент для викладачів, який дозволяє планувати екзамени та контрольні роботи (вказування дати, часу, аудиторії).
- **ExamCalendar:** Компонент, який показує студентам розклад майбутніх екзаменів.
- **ExamResult:** Компонент, де студенти можуть переглядати результати своїх екзаменів.
- **Prisma Component:** Використовується для збереження інформації про екзамени та результати у базі даних.
